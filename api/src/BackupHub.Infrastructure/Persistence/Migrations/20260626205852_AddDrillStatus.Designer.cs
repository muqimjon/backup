...
namespace BackupHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260626205852_AddDrillStatus")]
    partial class AddDrillStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackupHub.Domain.Entities.BackupArtifact", b =>
                {
                    ...
                    b.Property<long?>("DrillRows")
                        .HasColumnType("INTEGER");

                    b.Property<int>("DrillStatus")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("DrillTables")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("DrilledAt")
                        .HasColumnType("INTEGER");
